 ...
 */
public class JiangXiElevenSelectFiveOptionalSixRadioActivityGroup extends
		LotteryRadioGroupActivityGroup {

	@Override
	protected void set_fRadioButtonsClasses() {
		_fRadioButtonsClasses = new Class<?>[] {
				JiangXiElevenSelectFiveOptionalSixSelfSelectViewPagerActivity.class,
				JiangXiElevenSelectFiveOptionalSixCourageSelectViewPagerActivity.class };
	}
}