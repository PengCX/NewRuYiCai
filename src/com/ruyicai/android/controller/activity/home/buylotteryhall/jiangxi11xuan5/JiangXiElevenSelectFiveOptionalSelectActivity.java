 ...
 */
public abstract class JiangXiElevenSelectFiveOptionalSelectActivity extends SelectNumberActivity
		implements PageChangeRadioButtonsInterface, PlayMethodTextViewInterface {
	{
	...
	public void setPageChangeRadioButtonTextResouceIds() {
		_fPageChangeRadioButtons.set_fRadioButtonTextResouceIds(new int[] {
				R.string.radiogroup_text_selfselect, R.string.radiogroup_text_courageselect });
	}
