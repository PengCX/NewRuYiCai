...
//					SelectNumberBallType.REDBALL, lossValues, true);
	 ...
	 */
	public class SuperLottoSelfSelectBettingBarButtonOnClickListenter implements OnClickListener {

		@Override
		public void onClick(View v) {
			switch (v.getId()) {
				case R.id.bettingbar_button_numberbasket:
					Toast.makeText(SuperLottoSelfSelectActivity.this, "你点击了大乐透球自选号码篮按钮",
							Toast.LENGTH_LONG).show();
					break;
				case R.id.bettingbar_button_clearselectednumber:
					Toast.makeText(SuperLottoSelfSelectActivity.this, "你点击了大乐透自选清除已选择号码按钮",
							Toast.LENGTH_LONG).show();
					break;
				case R.id.bettingbar_button_addtonumberbasket:
					Toast.makeText(SuperLottoSelfSelectActivity.this, "你点击了大乐透自选加入号码篮按钮",
							Toast.LENGTH_LONG).show();
					break;
