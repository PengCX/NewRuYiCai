...
public class JiangXiElevenSelectFiveOptionalEightSelfSelectViewPagerActivity extends
	...
	protected String setPlayMethodTextViewText() {
		String playMethodString = getResources().getString(
				R.string.jiangxi11xuan5_textview_selfselect_optionaleightpalymethod);
