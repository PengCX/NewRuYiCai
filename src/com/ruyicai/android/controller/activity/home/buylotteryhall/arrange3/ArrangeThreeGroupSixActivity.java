...
public class ArrangeThreeGroupSixActivity extends SelectNumberActivity implements
	...
	public void setPageChangeRadioButtonTextResouceIds() {
		_fPageChangeRadioButtons.set_fRadioButtonTextResouceIds(new int[] {
				R.string.radiogroup_text_arrangesix, R.string.radiogroup_text_arrangesixsum });
	}
