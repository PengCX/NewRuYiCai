...
public class Welfare3DSelfSelectActivity extends SelectNumberActivity implements
	 ...
	 */
	public class Welfare3DSelfSelectBettingBarButtonOnClickListenter implements OnClickListener {

		@Override
		public void onClick(View v) {
			switch (v.getId()) {
				case R.id.bettingbar_button_numberbasket:
					Toast.makeText(Welfare3DSelfSelectActivity.this, "你点击了福彩3D球自选号码篮按钮",
							Toast.LENGTH_LONG).show();
					break;
				case R.id.bettingbar_button_clearselectednumber:
					Toast.makeText(Welfare3DSelfSelectActivity.this, "你点击了福彩3D自选清除已选择号码按钮",
							Toast.LENGTH_LONG).show();
					break;
				case R.id.bettingbar_button_addtonumberbasket:
					Toast.makeText(Welfare3DSelfSelectActivity.this, "你点击了福彩3D自选加入号码篮按钮",
							Toast.LENGTH_LONG).show();
					break;
