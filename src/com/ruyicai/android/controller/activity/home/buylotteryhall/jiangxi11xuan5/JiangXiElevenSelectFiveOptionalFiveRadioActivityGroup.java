 ...
 */
public class JiangXiElevenSelectFiveOptionalFiveRadioActivityGroup extends
		LotteryRadioGroupActivityGroup {

	@Override
	protected void set_fRadioButtonsClasses() {
		_fRadioButtonsClasses = new Class<?>[] {
				JiangXiElevenSelectFiveOptionalFiveSelfSelectViewPagerActivity.class,
				JiangXiElevenSelectFiveOptionalFiveCourageSelectViewPagerActivity.class };
	}
}