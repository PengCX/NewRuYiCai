...
public class SlideSeekBar extends LinearLayout {
...

	{
		...
		_fReduceImageButton.setOnClickListener(new SlideSeekBarButtonOnClickListener());
		_fSlideSeekBar = (SeekBar) findViewById(R.id.slideseekbar_seekbar);
		_fSlideSeekBar.setOnSeekBarChangeListener(new SlideSeekBarOnSeekBarChangedListener());
		_fAddImageButton = (ImageButton) findViewById(R.id.slideseekbar_imagebutton_add);
		_fAddImageButton.setOnClickListener(new SlideSeekBarButtonOnClickListener());
	 ...
	 * @since RYC1.0 2013-4-20
	 */
	class SlideSeekBarOnSeekBarChangedListener implements OnSeekBarChangeListener {
