...
public class TitleBar extends RelativeLayout {
     ...
     * 设置标题栏左标签的文本显示
     *
     * @param aLeftTextId 显示文本的字符串资源id
     */
     ...
     * 设置标题栏左标签的文本显示
     *
     * @param aLeftTextString 显示文本的字符串
     */
    ...
    public TitleBar(Context aContext, AttributeSet aAttributeSet) {
		...
		try {
			...
			_fIsShowSpreadButton = typedArray.getBoolean(
					R.styleable.TitleBar__fIsShowSpreadButton, false);
		} finally {
			typedArray.recycle();
		}
